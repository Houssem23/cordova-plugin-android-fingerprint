package com.cordova.plugin.android.fingerprintAuthentication;
...
@TargetApi(23)
public class fingerprintAuthentication extends CordovaPlugin {

	public static final String TAG = "fingerprintAuthentication";
	...
	public void initialize(CordovaInterface cordova, CordovaWebView webView) {
		...
		Log.v(TAG, "Init fingerprintAuthentication");
	...
	public boolean execute(final String action,
		...
		Log.v(TAG, "fingerprintAuthentication action: " + action);
		if (android.os.Build.VERSION.SDK_INT < 23) {
